...
class BeveragePreferenceServiceIf {
 public:
  ...
  virtual BeverageName::type GetBeverage(const BeverageType::type btype) = 0;
};
...
class BeveragePreferenceServiceNull : virtual public BeveragePreferenceServiceIf {
 public:
  ...
  BeverageName::type GetBeverage(const BeverageType::type /* btype */) override {
    BeverageName::type _return = static_cast<BeverageName::type>(0);
    return _return;
  }
};
...
class BeveragePreferenceService_GetBeverage_result {
 public:
  ...
  BeveragePreferenceService_GetBeverage_result(const BeveragePreferenceService_GetBeverage_result&) noexcept;
  BeveragePreferenceService_GetBeverage_result& operator=(const BeveragePreferenceService_GetBeverage_result&) noexcept;
  BeveragePreferenceService_GetBeverage_result() noexcept
                                               : success(static_cast<BeverageName::type>(0)) {
  }
   ...
   * @see BeverageName
   */
  BeverageName::type success;

  _BeveragePreferenceService_GetBeverage_result__isset __isset;

  void __set_success(const BeverageName::type val);
...
class BeveragePreferenceServiceClient : virtual public BeveragePreferenceServiceIf {
 ...
 public:
  ...
  BeverageName::type recv_GetBeverage();
 protected:
  ...
  BeveragePreferenceServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  BeverageName::type recv_GetBeverage(const int32_t seqid);
 protected:
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> piprot_;
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> poprot_;
  ::apache::thrift::protocol::TProtocol* iprot_;
