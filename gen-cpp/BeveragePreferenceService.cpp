    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->success = static_cast<BeverageName::type>(ecast8);
    ...
    switch (fid)
    {
      case 0:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          (*(this->success)) = static_cast<BeverageName::type>(ecast9);
          this->__isset.success = true;
        } else {
          xfer += iprot->skip(ftype);
        }
...
BeverageName::type BeveragePreferenceServiceClient::GetBeverage(const BeverageType::type btype)
{
...
BeverageName::type BeveragePreferenceServiceClient::recv_GetBeverage()
{
...
BeverageName::type BeveragePreferenceServiceConcurrentClient::GetBeverage(const BeverageType::type btype)
{
...
BeverageName::type BeveragePreferenceServiceConcurrentClient::recv_GetBeverage(const int32_t seqid)
{
